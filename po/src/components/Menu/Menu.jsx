    ...
    <div className="menu_container">
            ...
            <div className="menu_consult">
                ...
                <div className="consult_actions">
                    <div className="consult_itens"><img src={iconNo} alt="no" /><p>Faltas</p></div>
                    <div className="consult_itens"><img src={iconStar} alt="no" /><p>Notas</p></div>
                    <div className="consult_itens"><img src={iconClock} alt="no" /><p>Aulas</p></div>
                    <div className="consult_itens"><img src={iconHistory} alt="no" /><p>Histórico</p></div>
                </div>
            </div>
            ...
            <div className="registry_title">
                ...
                <div className="registry_actions">
                    <div className="registry_itens"><img src={iconClass} alt="no" /><p>Disciplinas</p></div>
                    <div className="registry_itens"><img src={iconDanger} alt="no" /><p>Pendências</p></div>
                </div>
            </div>
            <div id="string2"></div>
            <div className="menu_actions">
                <div className="menu_actions_img"><img src={iconGear} alt="" /><p>Configurações</p></div>
                <div className="menu_actions_img"><img src={iconQuit} alt="" /><p>Sair</p></div>
            </div>
            <div></div>
        </div>
  )
